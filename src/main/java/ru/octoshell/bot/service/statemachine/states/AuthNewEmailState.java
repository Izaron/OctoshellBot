...
@Slf4j
@Service
public class AuthNewEmailState implements State {

    private final BotLinkService botLinkService;
    private final LocaleService localeService;
    private final UserStateService userStateService;

    public AuthNewEmailState(BotLinkService botLinkService,
    ...
    public UserState transition(OctoshellTelegramBot bot, Update update) {
        ...
        if (message.hasText()) {
            ...
            botLinkService.updateEmail(userId, text);
    ...
    public void explain(UserState userState, OctoshellTelegramBot bot, Update update) {
        ...
        sendMessage.setText(localeService.get(locale, "auth.email.message"));
